    ...
    return `
      ...
      <article class="chat-message assistant brief-message"><span class="avatar">AI</span><div class="brief-wrap">
        ...
        <section class="brief-card brief-card-redesign">
          <header class="brief-card-header"><div><small>任务设置</small><strong>选择一种处理方式</strong><p>不同方式可以复用视频分析，但会分别保存结果和对话。</p></div><span class="brief-ready-badge" id="briefReadyBadge">视频已就绪</span></header>
          <div id="briefWorkflowHelp" class="brief-workflow-help brief-auto-route"><div><strong>让 AI 推荐处理方式</strong><p>描述最终想得到的内容，AI 只推荐流程，不会直接开始任务。</p></div><label class="brief-auto-query" for="briefAutoInstruction"><span class="sr-only">描述想得到的结果</span><textarea id="briefAutoInstruction" rows="2" placeholder="例如：重点保留产品介绍，剪成一条完整视频"></textarea></label><div class="brief-auto-submit"><small>存在歧义时会先让你确认。</small><button type="button" data-start-auto-workflow>让 AI 推荐</button></div></div>
          <div class="workflow-choice-divider"><span>或者手动选择</span></div>
          <div class="workflow-entry-grid" role="radiogroup" aria-label="选择剪辑方式">
            <button type="button" class="workflow-entry-card" data-workflow-choice="highlight" aria-pressed="false"><i><svg viewBox="0 0 24 24" aria-hidden="true"><path d="m12 3 1.6 5.4L19 10l-5.4 1.6L12 17l-1.6-5.4L5 10l5.4-1.6zM18.5 15.5l.7 2.3 2.3.7-2.3.7-.7 2.3-.7-2.3-2.3-.7 2.3-.7z" /></svg></i><span><strong>高光剪辑</strong><small>通看全片，发现事件并生成多个高光版本</small></span><b>自动编排</b></button>
            <button type="button" class="workflow-entry-card" data-workflow-choice="content_search" aria-pressed="false"><i><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="10.5" cy="10.5" r="5.5" /><path d="m15 15 4.5 4.5" /></svg></i><span><strong>内容探索</strong><small>按描述查找动作、场景、对白、文字或声音</small></span><b>按需检索</b></button>
            <button type="button" class="workflow-entry-card" data-workflow-choice="person_edit" aria-pressed="false"><i><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="3.5" /><path d="M5.5 19c.8-3.4 3-5.2 6.5-5.2s5.7 1.8 6.5 5.2" /></svg></i><span><strong>按人物剪辑</strong><small>从人物卡选择目标，提取所有出镜片段</small></span><b>依据画面</b></button>
            <button type="button" class="workflow-entry-card" data-workflow-choice="speaker_edit" aria-pressed="false"><i><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 12h2M8 8v8M12 5v14M16 8v8M20 10v4" /></svg></i><span><strong>按说话人剪辑</strong><small>区分不同声音，试听后提取对应发言</small></span><b>依据声音</b></button>
          </div>
